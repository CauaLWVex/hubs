  ...
  return (
    <Column as="form" className={styles.content} {...rest}>
      <TextInputField
        ...
        label={<FormattedMessage id="avatar-settings-content.display-name-label" defaultMessage="Nome de Exibição" />}
        value={displayName}
        ...
        description={
          <FormattedMessage
            ...
            defaultMessage="Alfanuméricos, hífens, e underlines. Pelo menos 3 carácteres, no máximo 32"
          />
        }
      ...
      <div className={styles.avatarPreviewContainer}>
        ...
        <Button type="button" preset="basic" onClick={onChangeAvatar}>
          <FormattedMessage id="avatar-settings-content.change-avatar-button" defaultMessage="Mudar Avatar" />
        </Button>
      </div>
